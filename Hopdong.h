...
class Hopdong {
    ...
    QString gethoten() {
        return QString::fromStdString(hoten);
    }
    void sethoten(QString hoten) {
        this->hoten = hoten.toStdString();
    }
    void setcmt(QString cmt) {
        this->cmt = cmt.toStdString();
    }
    void setloaixe(QString loaixe) {
        this->loaixe = loaixe.toStdString();
    }
    QString getcmt() {
        return QString::fromStdString(cmt);
    }
    QString getloaixe() {
        return QString::fromStdString(loaixe);
    }
    int getngaythue() {
